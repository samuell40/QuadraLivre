...
import AdicionarModalidadeModal from '@/components/modalidades/AdicionarModalidadeModal.vue'
import DetalharModalidadeModal from '@/components/modalidades/DetalharModalidadeModal.vue'
